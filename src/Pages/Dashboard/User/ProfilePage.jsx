    ...
    <div className="min-h-screen bg-gray-100 p-4 sm:p-6">
      <div className="max-w-2xl mx-auto">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Profile <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-emerald-600">Settings</span></h1>
          ...
          <div className="p-4 sm:p-6 md:p-8">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 mb-6">
              ...
              <div className="text-center sm:text-left">
                <h2 className="text-xl sm:text-2xl font-bold">{user.displayName || "No Name"}</h2>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-red-600 text-sm mt-1">
                      You are currently blocked from reporting issues. Please contact support.
                    </p>
                  </div>
                </div>
              </div>
